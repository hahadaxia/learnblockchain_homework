...
//     const deployments = {} ;
//     deployments["address"] = addr;
//     deployments["contactName"] = arfifacts.contactName;
//     await writeLog(deployments,name,network);

//     const abis = {};
//     abis["contactName"] = artifacts.contactName;
//     abis["abis"] = artifacts.abi;

//     const deploymentPath = path.resolve(__dirname,`../deployments/abis/${abis["contractName"]}.json`);
//     await writeFile(deploymentPath,JSON.stringify(abis,null,2));
// }